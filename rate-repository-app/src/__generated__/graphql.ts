...
export type RepositoryReviewFragment = { __typename?: 'Review', id: string, text?: string | null, rating: number, createdAt: any, repository: { __typename?: 'Repository', fullName: string }, user: { __typename?: 'User', id: string, username: string } } & { ' $fragmentName'?: 'RepositoryReviewFragment' };
